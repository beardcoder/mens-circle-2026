...
export default function Header({ siteName, hasNextEvent }: HeaderProps) {
  return (
    <header className="header" id="header">
      <div className="container">
        <div className="header__inner">
          <Link href="/" className="logo" aria-label={`${siteName} - Startseite`}>
            <svg className="logo__icon" viewBox="0 0 512 512" aria-hidden="true">
              <path
                fill="currentColor"
            ...
            <span className="logo__text">Männerkreis</span>
          </Link>

          <nav className="nav" id="nav">
            <Link href="/#ueber" className="nav__link">
              Über
            </Link>
            ...
            {hasNextEvent && (
              <Link href="/events" className="btn btn--primary btn--large nav__cta">
                Nächster Termin
              </Link>
            )}
          </nav>

          <button className="nav-toggle" id="navToggle" aria-label="Menü öffnen">
            <span></span>
            <span></span>
            <span></span>
          </button>
