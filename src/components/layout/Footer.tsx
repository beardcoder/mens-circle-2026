  ...
  return (
    <footer className="footer">
      <div className="container">
        <div className="footer__top stagger-children">
          <div className="footer__brand">
            <Link href="/" className="footer__logo">
              <svg className="footer__logo-icon" viewBox="0 0 512 512" aria-hidden="true">
                <path
                  fill="currentColor"
          ...
          <div className="footer__nav">
            ...
            <ul className="footer__links">
              ...
              <li>
                <Link href="/testimonials">Stimmen</Link>
              </li>
              <li>
        ...
        <div className="footer__bottom fade-in">
          <p className="footer__copyright">{settings?.footerText || '© 2025 Männerkreis Niederbayern'}</p>
