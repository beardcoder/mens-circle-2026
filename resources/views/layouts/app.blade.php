    ...
    <header class="header" id="header">
        <div class="container">
            <div class="header__inner">
                <a href="{{ route('home') }}" class="logo" aria-label="{{ $siteName }} - Startseite">
        ...
        <div class="container">
            <div class="footer__top">
                ...
                <div class="footer__contact">
                    ...
                    <ul class="footer__links">
                        @if($contactEmail)
                            <li><a href="mailto:{{ $contactEmail }}">E-Mail schreiben</a></li>
                        @endif
                        @if($contactPhone)
                            <li><a href="tel:{{ str_replace([' ', '-', '(', ')'], '', $contactPhone) }}">{{ $contactPhone }}</a></li>
                        @endif
