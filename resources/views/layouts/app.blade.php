...
<head>
    ...
    <meta name="title" content="@yield('meta_title', $siteName . ($siteTagline ? ' – ' . $siteTagline : ''))">
    <meta name="description" content="@yield('meta_description', $siteDescription ?: 'Authentischer Austausch, Gemeinschaft und persönliches Wachstum für Männer in Niederbayern.')">
    ...
    <meta property="og:description" content="@yield('og_description', $siteDescription ?: 'Authentischer Austausch, Gemeinschaft und persönliches Wachstum für Männer in Niederbayern.')">
    ...
    <meta property="twitter:title" content="@yield('twitter_title', $siteName)">
    <meta property="twitter:description" content="@yield('twitter_description', $siteDescription ?: 'Authentischer Austausch, Gemeinschaft und persönliches Wachstum für Männer in Niederbayern.')">
    ...
    <header class="header" id="header">
        <div class="container">
            <div class="header__inner">
                <a href="{{ route('home') }}" class="logo" aria-label="{{ $siteName }} - Startseite" data-m:click="action=nav_click;element=logo;location=header">
        ...
        <div class="container">
            <div class="footer__top">
                ...
                <div class="footer__contact">
                    ...
                    <ul class="footer__links">
                        @if($contactEmail)
                            <li><a href="mailto:{{ $contactEmail }}" data-m:click="action=contact_click;element=email;location=footer">E-Mail schreiben</a></li>
                        @endif
                        @if($contactPhone)
                            <li><a href="tel:{{ str_replace([' ', '-', '(', ')'], '', $contactPhone) }}" data-m:click="action=contact_click;element=phone;location=footer">{{ $contactPhone }}</a></li>
                        @endif
