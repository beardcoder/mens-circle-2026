    ...
    <div class="container">
        <div class="whatsapp__layout fade-in">
            <div class="whatsapp__content">
                <p class="whatsapp__eyebrow">Community</p>
                <h2 class="whatsapp__title">Tritt unserer <span class="whatsapp__highlight">WhatsApp Community</span> bei</h2>
            ...
            <div class="whatsapp__action">
                <a href="{{ $whatsappCommunityLink }}" target="_blank" rel="noopener noreferrer" class="whatsapp__button">
                    <svg class="whatsapp__icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
